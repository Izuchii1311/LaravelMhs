...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <h1 class="text-center mb-3 mt-4">Tambah Data Mahasiswa</h1>

        <div class="row justify-content-center">
          <div class="col-8">
           <div class="card">
              <div class="card-body">
                <form action="/insertdatamahasiswa" method="POST" enctype="multipart/form-data">
                  @csrf

                    <div class="mb-3">
                      <label for="nama" class="form-label">Nama Lengkap</label>
                      <input type="text" name="nama" class="form-control" id="nama" aria-describedby="nama" placeholder="Masukkan nama anda ...">
                    </div>
                    <div class="mb-3">
                      <label for="npm" class="form-label">NPM</label>
                      <input type="number" name="npm" class="form-control" id="npm" aria-describedby="npm" placeholder="Masukkan NPM anda ...">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" name="telp" class="form-control" id="telp" aria-describedby="telp" placeholder="Masukkan nomor telephone anda ...">
                    </div>
                    <div class="mb-3">
